  ...
  return (
    <div className='leftt'>
        <div className="container">
          ...
          <div className="item">
            <img src="https://img.icons8.com/?size=512&id=PVtje9ZH06QQ&format=png" alt="events" />
            <span>Events</span>
          </div>
          <div className="item">
            <img src="https://img.icons8.com/?size=512&id=35545&format=png" alt="game" />
            <span>Game</span>
          </div>
          <div className="item">
            <img src="https://img.icons8.com/?size=512&id=45228&format=png" alt="game" />
            <span>Gallery</span>
          </div>
          <div className="item">
            <img src="https://img.icons8.com/?size=512&id=Aj8bG2vL2rO3&format=png" alt="videos" />
            <span>Videose</span>
          </div>
          <div className="item">
            <img src="https://img.icons8.com/?size=512&id=13826&format=png" alt="message" />
            <span>Message</span>
          </div>
            </div>
          </div>
